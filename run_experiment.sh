...
do
	...
	echo "mpirun -n 256 --npernode 8 --hostfile ./hostfile ./3d_coded_summa_sys -n 8 -k 8 -N 4 -K 2 -f 1 -m ${m} -l"
	mpirun -n 256 --npernode 8 --hostfile ./hostfile ./3d_coded_summa_sys -n 8 -k 8 -N 4 -K 2 -f 1 -m ${m} -l       
	...
	echo "mpirun -n 256 --npernode 8 --hostfile ./hostfile ./replication_3d_summa -n 8 -k 8 -N 4 -K 2 -f 1 -m ${m}"
	mpirun -n 256 --npernode 8 --hostfile ./hostfile ./replication_3d_summa -n 8 -k 8 -N 4 -K 2 -f 1 -m ${m}       
	...
	mpirun -n 256 --npernode 8 --hostfile ./hostfile ./3d_coded_summa -n 8 -k 8 -N 4 -K 2  -m ${m} -l       
